...
const List<Map<String, dynamic>> languagesData = [
  ...
  {"code": "az", "name": "Azərbaycan dili", "flag": "🇦🇿", "englishName": "Azerbaijani"},
  {"code": "cs", "name": "Čeština", "flag": "🇨🇿", "englishName": "Czech"},
  {"code": "zh-HK", "name": "中文（香港）", "englishName": "Chinese (Hong Kong)", "flag": "🇭🇰"},
  {"code": "zh-TW", "name": "中文（繁體）", "englishName": "Chinese (Traditional)", "flag": "🇹🇼"},
  {"code": "zh", "name": "中文（简体）", "englishName": "Chinese (Simplified)", "flag": "🇨🇳"},
  {"code": "el", "name": "Ελληνικά", "englishName": "Greek", "flag": "🇬🇷"},
  {"code": "es-419", "name": "Español (Latinoamérica)", "englishName": "Spanish (Latin America)", "flag": "🌎"},
  {"code": "es-US", "name": "Español (Estados Unidos)", "englishName": "Spanish (United States)", "flag": "🇺🇸"},
  {"code": "es", "name": "Español (España)", "englishName": "Spanish (Spain)", "flag": "🇪🇸"},

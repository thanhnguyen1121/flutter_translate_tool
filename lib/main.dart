...
import 'package:demo_deep_link/pages/home_page.dart';
import 'package:demo_deep_link/pages/native_view_example.dart';
import 'package:demo_deep_link/pages/speech_to_text_page.dart';
import 'package:demo_deep_link/pages/translate_tool.dart';
...
void main() => runApp(const MaterialApp(home: TranslateTool()));
          ...
          FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const NativeViewExample(),
                ),
              );
            },
          ),
          ...
          FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const TranslateTool(),
                ),
              );
            },
          ),
